...
export type WorkspaceSection = "mission" | "atlas" | "surface" | "findings" | "intelligence" | "imports" | "reports" | "operations";

export const olympusCommandDestinations: ReadonlyArray<readonly [WorkspaceSection, string, string]> = [["mission", "Acropolis Command", "G M"], ["atlas", "Helios Cartographium", "G A"], ["surface", "Ares Perimeter", "G S"], ["findings", "Athena’s Tribunal", "G F"], ["intelligence", "Hermes Constellation", "G I"], ["imports", "Hephaestus Forge", "G H"], ["reports", "Muses’ Archive", "G R"], ["operations", "Zeus’ Stewardship", "G O"]] as const;
